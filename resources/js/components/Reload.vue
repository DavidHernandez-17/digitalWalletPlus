                                ...
                                <div class="row mt-2">
                                    <div class="col-md-12">
                                        <div :class="['form-group', {'has-error': messages.cell_phone}]">
                                            ...
                                            <input class="form-control text-sm form-control-solid" v-model="cell_phone" type="text" placeholder="TI, CC, CE, NIT" />
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-12">
                                        <div :class="['form-group', {'has-error': messages.value}]">
                                            ...
                                            <input class="form-control text-sm form-control-solid" v-model="value" type="text" placeholder="TI, CC, CE, NIT" />
